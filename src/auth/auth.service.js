...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.signUp = function (authCredentialsDto) {
        return __awaiter(this, void 0, void 0, function () {
            var username, password, salt, _a, _b, error_1;
            var _c;
    ...
    AuthService.prototype.validateUserPassword = function (authCredentialsDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.validatePassword(password, user.password, user.salt)];
                    case 2:
                        _a = (_b.sent());
                        _b.label = 3;
                    case 3:
    ...
    AuthService.prototype.validatePassword = function (password, hashPassword, salt) {
        return __awaiter(this, void 0, void 0, function () {
            var hash;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        hash = _a.sent();
                        return [2 /*return*/, hash === hashPassword];
                }
            });
        });
    };
    AuthService.prototype.signIn = function (authCredentialsDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.validateUserPassword(authCredentialsDto)];
                    case 1:
                        username = _a.sent();
                        if (username) {
